...
| ---------------------- | ---------------- | ---------------- | --------------------- |
| `check_palindrome_1`   | 8.25 msec per loop               |  6.04 msec per loop                |81.9 msec per loop                       |
| `check_palindrome_2`   |5.15 msec per loop                  |4.54 msec per loop                  |8.47 msec per loop                       |
